...
def main(argv=None):
    ...
    # their catalog max, since the raw scales differ a lot). Stamina and no-CMOD
    # (reading) get their own additive sections below instead -- they cut
    ...
    # Stamina and no-CMOD: additive (a chart can also be in a dominant tech
    # section above). Stamina = at least a quarter of the catalog's peak stamina;
    # no-CMOD = charts played without a CMOD (reading).
